...
\node [ wideitem=2](a) at (1,1) {%
            ...
            \begin{enumerate}
            	\item upcoming post繼續否？
            	\begin{itemize}
			\item 為何有點不想弄？(2017下半年流年不利，心情差無心，連GO match都不想看。)
            		\item 能有個網頁可以follow喜歡隊伍的賽程，是還不錯，但當然不是必須的。主要是想看的時候，可以馬上有個網頁可以馬上看到想看的結果，不用在上去Liquipedia或HLTV然後要點老半天找老半天，才找的到喜歡的隊伍的賽程。Gosugamer.com現在有了。
            	...
            	\end{itemize}
            	\item GO model是否要更新成更正確的model？(如果想用上足球聯賽)。試試一點點慢來，不急，一直想若是快點完成能應用上足聯該有多好，這樣反而覺得一直沒有去弄很煩，覺得問題很大。各個擊破。另外一直想著問題大，反而遲遲不肯動手，慢慢累積。除非足聯有動作，不然不continue了。2018Jan:進一步整理後發現其實兩個models非常接近，需要做進一步的比較才會知道孰優孰劣。
            	\item GO心得撰寫，整理加TOC。(短多)
           \end{enumerate}
            };

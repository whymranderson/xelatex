...
\node [ item=2, below = of a](sustain) {%
	...
	\node [above right = of a, align = center, anchor = south] (title){\parbox[c][][c]{0.1\textwidth}{\includegraphics[width=0.1\textwidth]{../../figs/logo_June27_2016.png}}\parbox[c][][c]{7cm}{\Huge fix \& craft F\&C fancy}};

...
\node [ item=4](a) at (1,1) {%
	...
	\begin{enumerate}
            \item GUI設計有點進展
            \item OpenGL animation關閉後要手動重啟一個新個interpreter，因為glut的關係，怎麼改進?python origianl idle可自己啟動。
...
\node [ item=2](tree) at (1,1) {%
	    ...
	    \input{./directorytree/menukeystree.tex}
	    };

\node [above right = of tree.north east, align=center, anchor = south] (title2){\includegraphics[width=0.6\textwidth]{../../../figs/test_new_logo_chinese.png}};

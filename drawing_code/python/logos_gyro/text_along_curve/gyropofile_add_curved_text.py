...
import sys
sys.path.append(r'C:\Documents and Settings\The One\My Documents\tony\2014\xelatexfolder\drawing_code\python\3D_geometry_annotate_program')
...
gylr = np.reshape(glrotatedvec[1,:],(nop,nol))
gzlr = np.reshape(glrotatedvec[2,:],(nop,nol))

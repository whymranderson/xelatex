...
ax2.text(*pA, s = r"$A$ at (0,0.5,0.5)", fontsize=14,verticalalignment='bottom', horizontalalignment='left')



tool.draw_perpendicular_sign(np.cross(px,pA),px,pA,po,ax2,0.1)

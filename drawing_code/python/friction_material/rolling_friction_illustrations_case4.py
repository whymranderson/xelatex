...
arc1 = (R/2)*circle_arc([0,0,-1],[-0.2,0.1,0],angleb,15)+cm
...
plt.text(cm[0],cm[1], r'$CM$', fontsize=14,verticalalignment='top', horizontalalignment='right')
...
#)
#ax.add_patch(arrow2)
#plt.text(cm[0]+pb[0]*2/3,cm[1]-0.05, r'$F_{p}$', fontsize=14,verticalalignment='top', horizontalalignment='left')
...
########
plt.show()
#fig3.savefig('case4a.pgf')#, facecolor=fig.get_facecolor(), edgecolor='none')
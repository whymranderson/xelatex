...
#)
#ax.add_patch(arrow1)
#plt.text((tangentp[0]+vecfr[0]+0.02),(tangentp[1]+vecfr[1]), r'$F_{fr}$', 
...
arrow3 = pat.FancyArrow(
    arrow3p1[0], arrow3p1[1], vecfr[0]/2,vecfr[1]/2,#increment
    width=0.04,        # Default
...
ax.add_patch(arrow3)
plt.text(arrow3p1[0]+vecfr[0]/2,arrow3p1[1]+vecfr[1]/2+0.1, r'$a$', 
         fontsize=14,verticalalignment='bottom', horizontalalignment='left')

#arrow3b = pat.FancyArrow(
...
#plt.text(arrow3p1[0]+vecfr[0],arrow3p1[1]+vecfr[1]+0.1, r'$v$', 
#         fontsize=14,verticalalignment='bottom', horizontalalignment='left')

arrow4 = pat.FancyArrow(
    edge[0], edge[1], vecfr[0],vecfr[1], #increment
    width=0.018,        # Default
    head_width=0.08,    # Default: 3 * width
    head_length=0.09    # Default: 1.5 * head_width
)
ax.add_patch(arrow4)
plt.text((edge[0]+vecfr[0]),(edge[1]+vecfr[1]), r'$F_{p}$', 
         fontsize=14,verticalalignment='top', horizontalalignment='left')

#arrow5 = pat.FancyArrow(
#    tangentp[0], tangentp[1], -vecfr[0],-vecfr[1], #increment
#    width=0.018,        # Default
#    head_width=0.08,    # Default: 3 * width
#    head_length=0.09    # Default: 1.5 * head_width
...
########
plt.show()
#fig3.savefig('friction_study3a.pgf')#, facecolor=fig.get_facecolor(), edgecolor='none')
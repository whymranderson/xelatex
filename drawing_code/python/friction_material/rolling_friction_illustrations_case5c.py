...
plt.text(0.5*cm[0]-0.03,0.3*cm[1], r'$R$',verticalalignment='bottom', horizontalalignment='right')
...
#plt.text(cm[0]+0.07,cm[1]+0.12, r'$\alpha$',verticalalignment='bottom', horizontalalignment='left')
...
plt.text(cm[0],cm[1], r'$CM$', verticalalignment='bottom', horizontalalignment='right')
...
#ax.add_patch(arrow1)
#plt.text(-pd[0]-0.1,-pd[1]+0.03, r'$F_{fr}$', 
...
#ax.add_patch(arrow2)
#plt.text(cm[0]+pb[0]*2/3+0.1,cm[1], r'$a$', 
...
arrow3 = pat.FancyArrow(
    2*cm[0], 2*cm[1], pb[0]-pc[0],pb[1]-pc[1],#increment
#    width=0.003,        # Default
...
ax.add_patch(arrow3)
fpp=2*cm+pb
plt.text(fpp[0],fpp[1]-0.05, r'$F_p$', 
...
########
plt.show()
fig3.savefig('case5a.pgf')#, facecolor=fig.get_facecolor(), edgecolor='none')
...
ax.add_patch(arrow3)
plt.text(arrow3p1[0]+vecfr[0],arrow3p1[1]+vecfr[1]+0.1, r'$v$', fontsize=20,verticalalignment='bottom', horizontalalignment='left')
...
########
plt.show()
#fig3.savefig('friction2.pgf')#, facecolor=fig.get_facecolor(), edgecolor='none')
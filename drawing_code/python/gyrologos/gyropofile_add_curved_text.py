...
import sys
sys.path.append(r'C:\Documents and Settings\The One\My Documents\tony\2014\xelatexfolder\drawing_code\pgf_related\3D_geometry_annotate_program')
...
#Turn function values into 3D data points
profiledata3D_upperhalf = np.array(zip(xx,scaley,np.zeros(len(xx))))
...
np.savetxt(r'C:\Documents and Settings\The One\My Documents\tony\2014\xelatexfolder\drawing_code\otherstuff\data_text_files\logoprofile.txt',dataaf, fmt='%.4f', delimiter=' ', newline='\n', header='', footer='', comments='# ')

...
\begin{pspicture}(-0.5in,0.2in)(5.5in,2.2in)
\psgrid

\rput[B](13 cm,-1.25cm){
\rnode{A}{
\includegraphics[scale=0.37]{logo_Aug29_test.PNG}%.././otherstuff
}}
...
\rnode{C}{
\large \textcolor{gray}{
\parbox{13cm}{從基礎的貼體角速度與牛頓尤拉方程簡單地衍伸到\\姿態估測法與物理引擎轉動積分器，實作與應用。}
}
}}
...
\rput[B](5.5 cm,3.3cm){
\rnode{E}{
\includegraphics[scale=0.5]{decoration_line.PNG}%..//otherstuff
}}

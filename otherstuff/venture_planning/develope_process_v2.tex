...
\node [ item=4](a) at (1,1) {%
		...
		\item 易德問$\omega_b$証。
		\item (排)加openGL coordinate圖。$\bullet\bullet\circ$
...
\node [above right = of thinking.north east, anchor = south] (title){\parbox[c][][c]{0.3\textwidth}{\includegraphics[width=0.3\textwidth]{../../figs/test_new_logo_chinese.png}}};

...
%TCIDATA{LastRevised=Wednesday, May 18, 2016 11:50:28}
...
\item 
\begin{eqnarray*}
Var\left( \mathbf{Y}\right)  &=&Var\left( \mathbf{x\beta }%
+\tsum\limits_{i=1}^{m}\mathbf{Z}_{i}\mathbf{a}_{i}+\mathbf{\varepsilon }%
\right)  \\

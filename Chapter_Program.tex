...
\underline{\color{blue}%
\smash{https://github.com/whymranderson/cordtrans/tree/GS\_version\_3}}}
...
%TCIMACRO{%
%\TeXButton{method_a_code}{def EulerDCMiter(self): 
%    '''Solve for next body angular velocity using Euler-Newton equations with current body orientation. Then rotate the body with the new body angular velocity to arrive at new orietation. Then repeat and iterate. Rotation of body is done with direction-cosine matrix (DCM) constructed from body angular velocity. This is the A method. Also this method use :math:`\\omega(t_{i+1})dt` in rotation vector approximation by default. One can also choose to use the J-cycle rotation approximation with option use_Jcycle=1.'''
...
%TCIMACRO{%
%\TeXButton{method_c_code}{\begin{minted}[linenos,fontsize=\footnotesize]{python}
%for i in range(1,self.N+1):
...
\U{7d1a}\U{7684}IC\U{3002}\U{56e0}\U{6b64}\U{6211}\U{5011}\U{7684}\U{7a0b}%
\U{5f0f}\U{78bc}\U{662f}\U{6709}\U{5176}\U{512a}\U{52e2}\U{3002}

# -*- coding: utf-8 -*-
#
# GyroSoft documentation documentation build configuration file, created by
...
project = u'GyroSoft Simulation'
copyright = u'2015, whymranderson'
...
htmlhelp_basename = 'GyroSoftdocumentationdoc'
...
latex_documents = [
  ('index', 'GyroSoftdocumentation.tex', u'GyroSoft Simulation Documentation',
   u'TL', 'howto'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'test_logo_Aug29.png'
...
# If false, no module index at the end is generated.
...
man_pages = [
    ('index', 'gyrosoftdocumentation', u'GyroSoft documentation Documentation',
     [u'TL'], 1)
]
...
texinfo_documents = [
  ('index', 'GyroSoftdocumentation', u'GyroSoft documentation Documentation',
   u'TL', 'GyroSoftdocumentation', 'One line description of project.',
   'Miscellaneous'),
]

...
%TCIDATA{LastRevised=Wednesday, April 02, 2014 15:41:25}
...
fixed在body上的任意向量都%
成立，所以body x, y軸也成%
立。\footnote{這邊相當證明了一般所知的dr/dt = \omega \times r}
另一個看法是，%
因為 space 與 body frame在t時重合%
，因此space的被動轉動矩%
陣$d\Omega $ = body的主動轉動矩%
陣$d\Omega $，稍後我們將會%
應用上這一重要的特%
性。這裡的結論是，%
主動特性的$d\Omega $等同於%
...
\begin{figure}
[th]
\caption{等周速運動\label{figure_uniform}}
\begin{center}
...
\href{https://drive.google.com/file/d/0B96HmLH-SQVmekx0a0RoSVFzWFE/edit?usp=sharing}{\underline{\color{blue}\smash{Python code can be found here.}}}

\href{http://tinypic.com/r/10cw9yf/8}{\underline{\color{blue}\smash{3D animation.}}}
